...
import collections
import numpy as np
from zero.z_utils.utilities_all import pad_clip_features, normalize_JP, normalize_pos, convert_rot, gripper_loc_bounds, normalise_quat
...
class ObsProcessorDA3D(ObsProcessorRLBenchBase):
    ...
    def dynamic_process_DP(self, data):
        batch = {}
        rgb = torch.from_numpy(np.stack(copy.deepcopy(data['rgb']), axis=0))
