...
class SimplePolicyDataset(Dataset):
    ...
    def _augment_pc(self, xyz, action_current, action_next, aug_max_rot):
        ...
        # add small noises (+-1mm)
        pc_noises = np.random.uniform(0, 0.001, size=xyz.shape)
        xyz = pc_noises + xyz
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='/data/zero/zero/v3/config/sort_shape_edge.yaml')
