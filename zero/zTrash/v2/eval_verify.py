...
class ServerArguments(tap.Tap):
    ...
    num_workers: int = 1
    queue_size: int = 20
    taskvar_file: str = '/data/zero/zero/v2/models/lotus/assets/taskvars_peract.json'
    num_demos: int = 20
    num_ensembles: int = 1
...
def main():
    ...
    for ckpt_num in check_point_number:
        ...
        args.exp_config = '/data/zero/zero/v2/config/after_shock.yaml'
        args.checkpoint = f'/data/logs/after_shock.yaml/lightning_logs/version_10/checkpoints/20250120_025303after_shock.yamlepoch={ckpt_num}.ckpt'
