...
"""
config_path = '/media/jian/ssd4t/zero/zero/expForwardKinematics/config/DP_traj.yaml'
...
episode_path = '/media/jian/ssd4t/zero/1_Data/B_Preprocess/DA3D/train/put_groceries_in_cupboard/variation0/episodes/episode0/data.pkl'
