...
#         bin_idx = []
#         for i in range(3):
#             point_idxs.append(idxs[i] // (2 * pos_bins))
#             bin_idx.append(idxs[i] % (2 * pos_bins))
#         for_visual = np.stack([point_idxs, bin_idx], 0)
