...
from zero.expForwardKinematics.models.DP.model.utils import *
...
def test_diffusion_unet_image_policy():
    shape_meta = {
        'obs': {
            'shape': (3, 64, 64),
            'type': 'rgb'
    ...
    obs_encoder = MultiImageObsEncoder(
        ...
        rgb_keys=['obs'],
        low_dim_keys=[],
        key_shape_map={'obs': (3, 64, 64)},
        key_model_map={'obs': None},
        key_transform_map={'obs': None},
    )
