...
import numpy as np
from zero.expBaseV5_2.models.lotus.utils.robot_box import RobotBox
from scipy.special import softmax
import torch

from zero.expBaseV5_2.models.lotus.utils.rotation_transform import (
    RotationMatrixTransform, quaternion_to_discrete_euler
)
import matplotlib.pyplot as plt
import random
from zero.expBaseV5_2.models.lotus.utils.action_position_utils import get_disc_gt_pos_prob
...
if __name__ == '__main__':
    # mixed args
    from zero.expBaseV5_2.config.default import build_args
    config = build_args()
    ...
    python -m zero.dataprocess.ObsProcessor\
        ...
        A_Selfgen /data/zero/1_Data/A_Selfgen/with_path_with_position\
