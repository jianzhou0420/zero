...
from zero.env.rlbench_lotus.environments import RLBenchEnv
...
class Arguments(tap.Tap):
    exp_config: str = '/workspace/zero/zero/v1/config/lotus.yaml'
    device: str = 'cuda'  # cpu, cuda

    seed: int = 42  # seed for RLBench
    num_demos: int = 20
    ...
    taskvar_file = '/workspace/zero/zero/v1/models/lotus/assets/taskvars_peract.json'
...
class Actioner(object):
    def __init__(self, args) -> None:
        ...
        model = TrainerLotus.load_from_checkpoint(checkpoint_path='/media/jian/ssd4t/test.ckpt')
