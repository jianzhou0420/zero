...
from zero.expAugmentation.trainer_FK import Trainer_DP
...
class Evaluator():
    ...
    def main():
        ...
        eval_config = build_args('/media/jian/ssd4t/zero/zero/expAugmentation/config/eval _fk.yaml')
        eval_config.defrost()
...
if __name__ == '__main__':
    Evaluator.main()
    # def test_actioner():
    #     eval_config = get_config('/media/jian/ssd4t/zero/zero/expAugmentation/config/eval _fk.yaml')
