import pickle
import re
from zero.expbasev4.models.lotus.utils.action_position_utils import get_disc_gt_pos_prob, BIN_SPACE
...
class SimplePolicyDataset(Dataset):
    def __init__(
        ...
        aug_max_rot=45, real_robot=False,
        bin_strategy=None, tasks_to_use=None, config=None, is_single_frame=True, **kwargs
    ):
    ...
    def get_entire_episode(self, g_episode):
        ...
        for t in range(num_frames):
            ...
            bin_space = (bin_space - centroid) / radius
