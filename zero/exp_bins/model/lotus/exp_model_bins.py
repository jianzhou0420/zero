...
from zero.expbasev4.models.lotus.utils.action_position_utils import get_best_pos_from_disc_pos, BIN_SPACE
'''
this is an archive version of origional simple_policy_ptv3.py
            ...
            if self.config.action_config.pos_pred_type == 'heatmap_disc':
                ...
                for i in range(len(npoints_in_batch)):
                    ...
                    test = get_best_pos_from_disc_pos(
                        ...
                        bin_space=bin_space  # best='ens' , topk=1
                    )
