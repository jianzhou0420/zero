...
from zero.v4.models.lotus.utils.rotation_transform import discrete_euler_to_quaternion
from zero.v4.models.lotus.base import BaseModel, RobotPoseEmbedding
from zero.v4.models.lotus.utils.rotation_transform import RotationMatrixTransform
from zero.v4.models.lotus.PointTransformerV3.model import (
    PointTransformerV3, offset2bincount, offset2batch
)
from zero.v4.models.lotus.PointTransformerV3.model_ca import PointTransformerV3CA
from zero.v4.models.lotus.utils.action_position_utils import get_best_pos_from_disc_pos
...
class SimplePolicyPTV3AdaNorm(BaseModel):
    ...
    def forward(self, batch, is_train=False):
        ...
        # 我修改了，只在eval时生效
        # 3.1 convert prediction to action_space
        if not is_train:  # means eval
            ...
            if self.config.action_config.pos_pred_type == 'heatmap_disc':
                ...
                for i in range(len(npoints_in_batch)):
                    ...
                    test = get_best_pos_from_disc_pos(
