import pickle
sample_data_path = '/data/zero/1_Data/A_Selfgen/0.005all/train/close_jar/variation0/episodes/episode0'
...
preprocess_data_path = '/data/zero/1_Data/B_Preprocess/0.005all/train/close_jar/variation0/episodes/episode0/data.pkl'
