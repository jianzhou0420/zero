...
do
    ...
    python /media/jian/ssd4t/zero/zero/expBins/eval_expbase.py \
    --config /media/jian/ssd4t/zero/zero/expBins/config/expbase_voxel_size_0.005_bins.yaml \
    --name test \
    --checkpoint /media/jian/ssd4t/zero/2_Train/2025_02_02__23-12_expBins_first_try/version_0/checkpoints/2025_02_02__23-12_expBins_first_try_epoch=799.ckpt \
    --tasks_to_use ${tasks_to_use[@]} 
